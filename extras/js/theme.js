        ...
        if (swiperSlider1x1.length) {
            swiperSlider1x1 = new Swiper(swiperSlider1x1, {
                ...
                paginationBulletRender: function (index, className) {
                    return '<div class="col-xs-2 col-sm-2 col-md-3 ' + className + '"><a href="#"><img src="src/assets/img/preview/cars/car-70x70x' + (index + 1) + '.jpg" alt=""/></a></div>';
                }
            });
        }
    ...
    if (typeof google === 'object' && typeof google.maps === 'object') {
        if ($('#map-canvas').length) {
            ...
            var mapIWcontent = '' +
                    ...
                    '<img src="src/assets/img/preview/cars/car-270x220x1.jpg" alt=""/>' +
            ...
            google.maps.event.addDomListener(window, 'load', function () {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 12,
                    center: new google.maps.LatLng(36.864667, 10.166500) // map coordinates
                };

                map = new google.maps.Map(document.getElementById('map-canvas'),
                        mapOptions);
                marker = new google.maps.Marker({
                    position: new google.maps.LatLng(36.864667, 10.166500), // marker coordinates
                    map: map,
                    icon: image,
                    title: 'Wave cars renting!'
                });
                /*
